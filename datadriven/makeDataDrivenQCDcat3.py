...
Data=ROOT.TFile.Open("/eos/user/s/shsong/HiggsDNA/root/cat3/Data_2017.root")
...
# DataFile=awkward.from_parquet("/eos/user/s/shsong/HiggsDNA/parquet/cat3/Data_2017.parquet")
...
awkward.to_parquet(DataFile,"/eos/user/s/shsong/HiggsDNA/parquet/cat3/DatadrivenQCD.parquet")

parquet_to_root("/eos/user/s/shsong/HiggsDNA/parquet/cat3/DatadrivenQCD.parquet","/eos/user/s/shsong/HiggsDNA/root/cat3/DatadrivenQCD.root",treename="cat3",verbose=False)
