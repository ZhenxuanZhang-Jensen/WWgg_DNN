...
void deriveSFscat2()
{
  ...
  string common_selection = "(Diphoton_mass<115 || Diphoton_mass>135)*(is_passPhotonMVA90)*(category==2)";
  ...
  filenames_map["data"] = { vector<string>{
      "/eos/user/s/shsong/HiggsDNA/root/cat2/Data_2017_m.root"
      // "/eos/user/s/shsong/HiggsDNA/root/cat2/Data_2017_e.root"
    }};
  filenames_map["qcd"] = { vector<string>{
      "/eos/user/s/shsong/HiggsDNA/root/cat2/DatadrivenQCD_m.root"
      // "/eos/user/s/shsong/HiggsDNA/root/cat2/DatadrivenQCD_e.root"
    }};
  filenames_map["diphoton"] = { vector<string>{
      "/eos/user/s/shsong/HiggsDNA/root/cat2/DiPhotonJetsBox_m.root"
      // "/eos/user/s/shsong/HiggsDNA/root/cat2/DiPhotonJetsBox_e.root"
    }};
  ...
  h_minphotonID["otherMC"] = new TH1F("constMC1","constMC1",13,-0.3,1);  
  h_minphotonID["MCtot"] = new TH1F("MCtot1","MCtot1",13,-0.3,1);
  h_minphotonID["scaledMCtot"] = new TH1F("MCtot1_scaled","MCtot1_scaled",13,-0.3,1);
  h_maxphotonID["otherMC"] = new TH1F("constMC2","constMC2",13,-0.3,1); 
  h_maxphotonID["MCtot"] = new TH1F("MCtot2","MCtot2",13,-0.3,1);
  h_maxphotonID["scaledMCtot"] = new TH1F("MCtot2_scaled","MCtot2_scaled",13,-0.3,1);
  ...
  // c1->SaveAs("Diphoton_minID_cat2_e.png");
  c1->SaveAs("Diphoton_minID_cat2_m.png");
  ...
  // c12->SaveAs("Diphoton_maxID_cat2_e.png");
  c12->SaveAs("Diphoton_maxID_cat2_m.png");
  ...
  // c2->SaveAs("minID_scale_cat2_e.png");
  c2->SaveAs("minID_scale_cat2_m.png");
  ...
  // c22->SaveAs("maxID_scale_cat2_e.png");
  // c22->SaveAs("maxID_scale_cat2_m.png");
}
