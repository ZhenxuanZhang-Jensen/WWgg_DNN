...
void deriveSFscat3()
{
  ...
  string common_selection = "(Diphoton_mass<115 || Diphoton_mass>135)*(is_passPhotonMVA90)*(category==3)";
  ...
  filenames_map["data"] = { vector<string>{
      "/eos/user/s/shsong/HiggsDNA/root/cat3/Data_2017.root"
    }};
  filenames_map["qcd"] = { vector<string>{
      "/eos/user/s/shsong/HiggsDNA/root/cat3/DatadrivenQCD.root"
    }};
  filenames_map["diphoton"] = { vector<string>{
      "/eos/user/s/shsong/HiggsDNA/root/cat3/DiPhotonJetsBox.root"
    }};
  ...
  h_minphotonID["otherMC"] = new TH1F("constMC1","constMC1",10,-0.3,1);  
  h_minphotonID["MCtot"] = new TH1F("MCtot1","MCtot1",10,-0.3,1);
  h_minphotonID["scaledMCtot"] = new TH1F("MCtot1_scaled","MCtot1_scaled",10,-0.3,1);
  h_maxphotonID["otherMC"] = new TH1F("constMC2","constMC2",10,-0.3,1); 
  h_maxphotonID["MCtot"] = new TH1F("MCtot2","MCtot2",10,-0.3,1);
  h_maxphotonID["scaledMCtot"] = new TH1F("MCtot2_scaled","MCtot2_scaled",10,-0.3,1);
