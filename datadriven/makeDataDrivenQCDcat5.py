...
DataFile=DataFile[DataFile.category==5]
...
c1.SaveAs("fakephoton_pdf_cat5.png")

Data=ROOT.TFile.Open("/eos/user/s/shsong/HiggsDNA/root/cat5/Data_2017.root")
Data_tree=Data.Get("cat5")
...
# DataFile=awkward.from_parquet("/eos/user/s/shsong/HiggsDNA/parquet/cat5/Data_2017.parquet")
...
awkward.to_parquet(DataFile,"/eos/user/s/shsong/HiggsDNA/parquet/cat5/DatadrivenQCD.parquet")

parquet_to_root("/eos/user/s/shsong/HiggsDNA/parquet/cat5/DatadrivenQCD.parquet","/eos/user/s/shsong/HiggsDNA/root/cat5/DatadrivenQCD.root",treename="cat5",verbose=False)
