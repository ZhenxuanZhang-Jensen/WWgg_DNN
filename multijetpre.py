...
model=load_trained_model("/hpcfs/cms/cmsgpu/shaoweisong/DNN/cat7qcd/model_Relu_36_features_3epochs_pointsName.h5")
allsignal=[]
...
ax.legend()
plt.savefig("/hpcfs/cms/cmsgpu/shaoweisong/DNN/cat7qcd/DNNscore300.png")
plt.show()
